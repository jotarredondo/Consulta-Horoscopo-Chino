...
<body class="fondo">
	...
	<%
		HoroscopoDTO respuesta = (HoroscopoDTO) request.getAttribute("respuestaSigno");
	%>
	...
	<div class="card shadow rounded m-5 px-5" id="back">
		...
		<div class="card align-item-center shadow rounded m-5 p-5" id="card1">
			...
			<div class="preview text-center">
				...
				<h1 class=" second text-center">Tu Signo es :</h1>
			</div>
				...
				<table class="table table-borderless">
					...
					<tbody>
						<tr>
							...
							<td><%=respuesta.getDescripcion()%></td>
