...
<title>Pre Modificar usuario</title>
<!-- Link Css -->
	...
	<div class="card shadow rounded m-5 px-5" id="back">
		...
		<div class="card align-item-center shadow rounded m-5 p-5" id="card1">
			...
			<div class="preview text-center">
				...
				<h1 class=" second text-center">Modificar usuarios</h1>
			</div>

			<div class="aling-items-center px-5 mx-5">
				<form action="PreModificarUsuario" method="post">


					<div class="form-group">
						<h4 class="primer text-center">Haga click para continuar</h4>

					</div>

					<div class="form-group">
						<input class="btn btn-block" type="submit" value="Modificar"
							id="boton" />
					</div>
