...
<body class="fondo">
	...
	<%
		RegistroDTO resultado = (RegistroDTO) request.getAttribute("user");
	%>
	...
	<div class="card shadow rounded m-5 px-5" id="back">
		...
		<div class="card align-item-center shadow rounded m-5 p-5" id="card1">
			...
			<div class="preview text-center">
				...
				<h1 class=" second text-center">Usuario encontrado</h1>
			</div>
			...
			<div class="aling-items-center px-5 mx-5">
				<table class="table table-borderless">
					...
					<tbody>
						<tr>
							<td><%=resultado.getUser()%></td>
							<td><%=resultado.getPassword()%></td>
				...
				<form action="BuscarUsuario" method="post">
					<div class="form-group">
						...
						<input class="form-control text-center" type="text"
							name="nombreFind" required placeholder="Ingrese nombre" /> <span
							class="Error"></span>
					</div>
