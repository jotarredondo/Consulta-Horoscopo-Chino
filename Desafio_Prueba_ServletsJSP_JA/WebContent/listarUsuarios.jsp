	...
	<div class="card shadow rounded m-5 px-5" id="back">
		...
		<div class="card align-item-center shadow rounded m-5 p-5" id="card1">
			...
			<div class="preview text-center">
				...
				<h1 class=" second text-center">Listar usuarios</h1>
			</div>
			...
			<div class="aling-items-center px-5 mx-5">
				...
				<form action="ListarRegistro" method="post">
					...
					<div class="form-group">
						<h4 class="primer text-center">Pulsa el botón para listar el
							registro</h4>

					</div>

					<div class="form-group">
						<input class="btn btn-block" type="submit" value="Listar"
							id="boton" />
					</div>
